...
public:
	...
	void onLoad() override {
		...
		logPluginEvent(QStringLiteral("load-sync-apply-start"));
		applyCurrentOpacityToTelegramWindows(QStringLiteral("load-sync"));
		logPluginEvent(QStringLiteral("load-sync-apply-finish"));
...
private:
	...
	void openSettingsDialog() {
		...
		logPluginEvent(QStringLiteral("panel-dialog-created"));
		...
		logPluginEvent(QStringLiteral("panel-dialog-configured"));

		auto layout = new QVBoxLayout(dialog);
		logPluginEvent(QStringLiteral("panel-layout-created"));
		...
		logPluginEvent(QStringLiteral("panel-intro-created"));
		...
		logPluginEvent(QStringLiteral("panel-value-created"));
		...
		logPluginEvent(QStringLiteral("panel-slider-created"));
		...
		logPluginEvent(QStringLiteral("panel-hint-created"));
		...
		logPluginEvent(QStringLiteral("panel-buttons-created"));
		...
		logPluginEvent(QStringLiteral("panel-connections-ready"));

		logPluginEvent(QStringLiteral("panel-show-start"));
		dialog->show();
		logPluginEvent(QStringLiteral("panel-show-finished"));
		dialog->raise();
		logPluginEvent(QStringLiteral("panel-raise-finished"));
	...
	void applyCurrentOpacityToTelegramWindows(const QString &reason) {
		...
		logPluginEvent(QStringLiteral("apply-pass-start"), QJsonObject{
