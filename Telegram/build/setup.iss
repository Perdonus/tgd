#define MyAppShortName "Astrogram"
#define MyAppName "Astrogram"
#define MyAppPublisher "Astrogram"
#define MyAppURL "https://github.com/Perdonus/tgd"
#define MyAppExeName "Astrogram.exe"
...
UninstallDisplayIcon={app}\Astrogram.exe
Compression=lzma
...
[Files]
Source: "{#ReleasePath}\Astrogram.exe"; DestDir: "{app}"; Flags: ignoreversion
